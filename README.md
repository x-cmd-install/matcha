...
[![x-cmd/install — matcha Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/matcha.svg)](https://x-cmd.com/install/matcha)
...
- **Stars**: 1,110 · **Forks**: 83 · **Open issues**: 871 · **Contributors**: 50

## Totals (cumulative)

- **Releases**: 112 · **Merged PRs**: 697 · **Open PRs**: 22 · **Closed issues**: 824 · **Open issues**: 47 · **Commits**: 789
...
- **Edit the package entry**: <https://github.com/x-cmd/install/edit/main/matcha.yml> (or whichever path the index uses)

The data on this page (card / loc / scorecard / release) is auto-collected by [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) and is regenerated daily. Improvements to *install behaviour* (which version gets installed, platform-specific quirks, dependencies) belong upstream in the index.

_Snapshot: `data/card/260926.yml` · 2026-09-26T05:00:27Z._
